using DiplomaApi.Application.Common.Models;
using DiplomaApi.Application.TodoItems.Commands.CreateTodoItem;
using DiplomaApi.Application.TodoItems.Commands.DeleteTodoItem;
using DiplomaApi.Application.TodoItems.Commands.UpdateTodoItem;
using DiplomaApi.Application.TodoItems.Commands.UpdateTodoItemDetail;
using DiplomaApi.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace DiplomaApi.Web.Endpoints;
